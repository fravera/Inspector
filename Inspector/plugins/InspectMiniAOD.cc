// -*- C++ -*-
//
// Package:    Inspector/InspectMiniAOD
// Class:      InspectMiniAOD
// 
/**\class InspectMiniAOD InspectMiniAOD.cc Inspector/InspectMiniAOD/plugins/InspectMiniAOD.cc
...
class InspectMiniAOD : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit InspectMiniAOD(const edm::ParameterSet&);
      ~InspectMiniAOD();
...
//
InspectMiniAOD::InspectMiniAOD(const edm::ParameterSet& iConfig)

{
   ...
   //Token
   tokGenParticle = consumes<reco::GenParticleCollection>(edm::InputTag("prunedGenParticles"));
   tokRecoPhoton = consumes<edm::View<reco::Photon> >(edm::InputTag("slimmedPhotons"));
...
void
InspectMiniAOD::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
InspectMiniAOD::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
InspectMiniAOD::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
InspectMiniAOD::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(InspectMiniAOD);
